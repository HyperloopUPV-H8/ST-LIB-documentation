...
\hypertarget{_zeroing_8hpp_source}{}\label{_zeroing_8hpp_source}\index{Inc/ST-\/LIB\_HIGH/Control/Blocks/Zeroing.hpp@{Inc/ST-\/LIB\_HIGH/Control/Blocks/Zeroing.hpp}}
...
\DoxyCodeLine{00019\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00020\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(has\_max\_value\ \&\&\ \mbox{\hyperlink{class_packet_value}{abs}}(mean\_calculator.output\_value)\ >\ max\_value\_offset)\ ErrorHandler(\textcolor{stringliteral}{"{}Zeroing\ offset\ is\ calculated\ to\ be\ above\ specified\ maximum"{}});}
