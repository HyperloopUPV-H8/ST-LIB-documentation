...
\hypertarget{_stack_state_order_8hpp_source}{}\label{_stack_state_order_8hpp_source}\index{Inc/ST-\/LIB\_LOW/StateMachine/StackStateOrder.hpp@{Inc/ST-\/LIB\_LOW/StateMachine/StackStateOrder.hpp}}
...
\DoxyCodeLine{00007\ \ \ \ \ \mbox{\hyperlink{class_packet_value}{StateMachine}}\&\ state\_machine;}
\DoxyCodeLine{00008\ \ \ \ \ StateMachine::state\_id\ state;}
\DoxyCodeLine{00009\ \ \ \ \ \mbox{\hyperlink{class_stack_state_order}{StackStateOrder}}(\mbox{\hyperlink{class_packet_value}{uint16\_t}}\ \textcolor{keywordtype}{id},\textcolor{keywordtype}{void}(*callback)(\textcolor{keywordtype}{void}),\ \mbox{\hyperlink{class_packet_value}{StateMachine}}\&\ state\_machine,\ StateMachine::state\_id\ state,\mbox{\hyperlink{class_packet_value}{Types}}*...\ values)\ :\ \mbox{\hyperlink{class_stack_order}{StackOrder}}<\mbox{\hyperlink{class_packet_value}{BufferLength}},\mbox{\hyperlink{class_packet_value}{Types}}...>(id,callback,values...),}
...
\DoxyCodeLine{00012\ \ \ \ \ \ \ \ \ \ \ \ \ ErrorHandler(\textcolor{stringliteral}{"{}State\ Machine\ does\ not\ contain\ state,\ cannot\ add\ StateOrder"{}});}
...
\DoxyCodeLine{00030\ \mbox{\hyperlink{class_stack_state_order}{StackStateOrder}}(\mbox{\hyperlink{class_packet_value}{uint16\_t}}\ \textcolor{keywordtype}{id},\textcolor{keywordtype}{void}(*callback)(\textcolor{keywordtype}{void}),\ \mbox{\hyperlink{class_packet_value}{StateMachine}}\&\ state\_machine,\ StateMachine::state\_id\ state,\mbox{\hyperlink{class_packet_value}{Types}}*...\ values)-\/>StackStateOrder<(!\mbox{\hyperlink{structhas__container}{has\_container}}<\mbox{\hyperlink{class_packet_value}{Types}}...>::value)*\mbox{\hyperlink{structtotal__sizeof}{total\_sizeof<Types...>::value}},\ \mbox{\hyperlink{class_packet_value}{Types}}...>;}
